...
Una vez que se dispone de la secuencia digital $x[n]$, el flujo se divide en dos procesos, sin embargo, convergen en el mismo resultado ees decir quee la Transformada Rápida de Fourier no es una aproximación numérica sino una ruta matemáticamente idéntica a la Transformada Discreta de Fourier.
